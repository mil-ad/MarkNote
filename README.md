...
* To install locally, download the latest [release](https://github.com/mil-ad/MarkNote/releases) and install by opening **Anki → Tools → Add-ons → Install** from file, then select **MarkNote.ankiaddon**
